...
def fight(unit_1, unit_2):
    ...
    while unit_2.is_alive:
        if unit_1.is_alive and r % 2 == 0: #it's time for unit_2 to attack
            unit_1.health -= max(unit_2.attack - unit_1.defense, 0) if isinstance(unit_1, Defender) else unit_2.attack
            unit_1.check_life()
        elif unit_1.is_alive and r % 2 == 1:
            unit_2.health -= max(unit_1.attack - unit_2.defense, 0) if isinstance(unit_2, Defender) else unit_1.attack
            unit_2.check_life()
        else:
            return False
        r += 1
